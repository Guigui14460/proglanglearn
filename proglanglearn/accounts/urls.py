...
urlpatterns = [
    ...
    path('profile/<int:profile_id>/report/',
         ProfileReportView.as_view(), name='profile-report'),
    path('profile/<int:user_id>/edit/experience/<int:experience_id>/',
         ExperienceDelete.as_view(), name='experience-delete'),
    path('profile/<int:user_id>/edit/education/<int:education_id>/',
