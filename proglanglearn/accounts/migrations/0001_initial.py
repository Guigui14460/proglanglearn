# Generated by Django 2.2.2 on 2019-06-15 19:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='user_pictures/default.png', upload_to='user_pictures/', verbose_name='Image de profil')),
                ...
                ('skills', models.ManyToManyField(blank=True, to='courses.Tag', verbose_name='Compétences')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Utilisateur associé')),
            ],
        ),
        migrations.CreateModel(
            name='Experience',
